...
### 협업 준비
- [ ] 프론트엔드(최성현)와 API 스펙 초안 협의
- [ ] 데이터 아키텍처(유재연)와 스키마 초안 협의
...
## 🔍 Day 4 (1/24 금): Vector DB 및 추천 API
...
- [ ] 데이터베이스 스키마 리뷰 (Day 1-2)
- [ ] Vector DB 연동 방식 (Day 4)
